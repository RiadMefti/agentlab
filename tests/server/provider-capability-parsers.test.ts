...
import { IncompatibleProviderCapabilityError } from "../../apps/server/src/domain/provider-capability-discovery.js";
import {
  NodeCommandRunner,
  type CommandRunner
...
} from "../../apps/server/src/infrastructure/providers/claude-capability-discovery.js";
import {
  CodexAppServerCatalogClient,
  parseCodexModels
} from "../../apps/server/src/infrastructure/providers/codex-capability-discovery.js";
import {
  OpenCodeCapabilityDiscovery,
  parseOpenCodeModels
} from "../../apps/server/src/infrastructure/providers/opencode-capability-discovery.js";
